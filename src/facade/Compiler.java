...
public class Compiler {
	...
	public String compile(String p_input) { 
		
		LexicalAnalyzer lex = new LexicalAnalyzer(p_input);
		Parser parser = new Parser(lex.getTokens());
		CodeGenerator generator = new CodeGenerator(parser.getParseTree());
		
		return generator.getMachineCode();
	}
}
