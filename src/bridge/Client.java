...
public class Client {
	public static void main(String[] args) {
		...
		for(int i = 1; i <= 2; i++ ) {
			if(i == 1) { 
				PlatformSetup.currentPlatform = PlatformSetup.XWIN;
			} else {
				PlatformSetup.currentPlatform = PlatformSetup.PMWIN;
			}
			...
			System.out.println("\nIconWindow");
			IconWindow iw = new IconWindow();

			System.out.println("\nTransientWindow");
			TransientWindow tw = new TransientWindow();
