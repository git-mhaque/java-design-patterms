...
public class Client {
	...
	public static void main(String[] args) {
		...
		FileSaveCommand fs = new FileSaveCommand();
		AppCloseCommand app = new AppCloseCommand();
		MacroCommand mc = new MacroCommand();
		mc.addCommand(fo);
		mc.addCommand(fs);
		mc.addCommand(app);
		
		invoker.invokeCommand(fo);	//File Open
		invoker.invokeCommand(fs);	//File Save
		invoker.invokeCommand(app);	//App Close
		invoker.invokeCommand(mc);	//File Open  File Save	App Close
	}
}
