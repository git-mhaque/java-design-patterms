...
public class Client {
	...
	public static void main(String[] args) {
		...
		Application app = new Application(null,true);
		Dialog dlg = new Dialog(app,true); 
		Button b = new Button(dlg,true);
		Label l = new Label(dlg,false);  // label has no help

		l.handleHelp();    // Dialog Help
		b.handleHelp();    // Button Help
		dlg.handleHelp();  // Dialog Help
		app.handleHelp();  // Application Help
