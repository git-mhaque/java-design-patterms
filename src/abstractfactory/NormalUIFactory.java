...
public class NormalUIFactory extends UIFactory {
	
	public Button createButton(String p_text) {
		return new NormalButton(p_text); 
	}

	public Label createLabel(String p_text) {
		return new NormalLabel(p_text); 
	}
