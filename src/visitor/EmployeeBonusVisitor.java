...
public class EmployeeBonusVisitor extends EmployeeVisitor {

	double m_totalBonus;
	
	public EmployeeBonusVisitor() {
		m_totalBonus = 0.00;
	}
	
	public void visitStaff(Staff p_staff) {
		m_totalBonus += p_staff.getBonus();
	}
	
	public void visitExecutive(Executive p_staff) {
		m_totalBonus += p_staff.getBonus();
	}
