...
public class Executive extends Employee {
	...
	public Executive(String p_name,double p_salary,double p_bonus) {
		super(p_name,p_salary,p_bonus);
	}
	
	public void accept(EmployeeVisitor p_visitor) {
		p_visitor.visitExecutive(this);
	}
